...
To get intraday prices, use the `Intradia()` method. By default the price interval is `1m`. Other values include `2m`, `5m`,
...
```python
ac = data.balance_s('ac', ['2018-03-31', '2019-03-31', '2020-03-31'])
ac.head()
```
...
Acces the code used on this examples [JUPYTER NOTEBOOK](Link por definir)

### Legal
dabu is distribuited under the BSD 3-Clause License.  See the [LICENSE.txt](https://github.com/dabu-io/dabu-dev/blob/main/LICENSE) for details.

Hope this package is usefull to you.  Please drop me a line with any sugestion, question or just to say hello!<br>
**Carlos Crespo**
***
...
```python
ac = data.balance_g('ac', ['2017-03-31','2018-03-31', '2019-03-31', '2020-03-31'])
ac.head()
```
...
```python
walmex = data.restulados('walmex', ['2019-09-30', '2020-09-30'])
walmex.head()
```
...
```python
walmex_cf = data.flujos('walmex',['2019-09-30', '2020-09-30'])
walmex_cf.head()
```
...
```python
income = data.comparar( 'flujos', '2020-09-30',['walmex', 'ac', 'femsa', 'cemex'])
income.head()
```
...
### Código del ejemplo 
Puedes consultar el código de estos ejemplos en [JUPYTER](LINK POR DEFINIR)

### Legal
dabu es distribuido bajo la licencia BSD 3-Clause.  Lee el archivo [LICENSE.txt](https://github.com/dabu-io/dabu-dev/blob/main/LICENSE) para mayor información.
